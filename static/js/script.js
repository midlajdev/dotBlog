$(document).ready(function () {
    ...
    // Facebook Share
    $("a.share-facebook").attr(
        "href",
        `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`
    );

    // WhatsApp Share
    $("a.share-whatsapp").attr(
        "href",
                        ...
                        if (status == "success") {
                            ...
                            if (!noResponsePopup) {
                                Swal.fire({
                                    ...
                                    if (redirect === "yes" && redirect_url && redirect_url.length > 0) {
                ...
                function doAfter() {
                    if (stable != "yes") {
                        ...
                        if (isRedirect && redirect === "yes") {
                            redirect_url = redirect_url.replace(/['"]/g, "").trim();
